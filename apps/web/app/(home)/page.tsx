...
export default function HomePage() {
  const features = [
    {
      title: "Run Locally or in Cloud",
      description:
        "Choose to run everything locally for complete privacy or use our cloud infrastructure for convenience.",
    },
    {
      title: "Your Models, Your Keys",
      description:
        "Connect your preferred AI models using your own API keys, keeping you in control of costs and capabilities.",
    },
    {
      title: "Advanced Document Analysis",
      description:
        "Upload and analyze documents with AI, making your files and data part of the conversation.",
    },
    {
      title: "Real-time Web Search",
      description:
        "Keep your AI conversations up-to-date with integrated web search capabilities.",
    },
    {
      title: "Developer-friendly",
      description:
        "Built-in code execution, LaTeX support, and data visualization tools for technical work.",
    },
    {
      title: "Smart Organization",
      description:
        "Organize conversations into projects and easily share or export your chat history.",
    },
  ];
          ...
          <div className="flex gap-4 py-20 lg:py-40 flex-col items-start">
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg max-w-xl lg:max-w-xl leading-relaxed tracking-tight text-muted-foreground">
                A powerful AI interface that adapts to your preferences, whether
                you want full local control or cloud convenience.
              </p>
            </div>
